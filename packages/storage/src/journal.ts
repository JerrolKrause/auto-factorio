...
export const entities: Entity[] = ['runs', 'agents', 'tasks', 'messages', 'observations', 'commands', 'measurements', 'interventions', 'checkpoints', 'budgets', 'artifacts', 'reservations', 'agentHistory'];
